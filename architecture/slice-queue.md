...
_Generated: 2026-06-02T17:53:48+00:00 by /slice during slice-103 definition_

## Candidates

### thin-vault-index-routers-and-enforce

- **Source:** user intent + AP-3 lessons recurrence
- **Blast-radius:** `architecture/slices/_index.md`, `architecture/slices/archive/_index.md`, `skills/archive/SKILL.md`
- **Parallel-safety:** NON-OVERLAPPING
- **Effort:** MEDIUM
- **Risk-retired:** MEDIUM

### add-region-anchored-marker-scan-build-check

- **Source:** slice-099/100 lessons (N=4)
- **Blast-radius:** `architecture/build-checks.md`
- **Parallel-safety:** NON-OVERLAPPING
- **Effort:** SMALL
- **Risk-retired:** LOW
...
- **Blast-radius:** `tools/install_audit.py`
- **Parallel-safety:** NON-OVERLAPPING
- **Effort:** MEDIUM
- **Risk-retired:** LOW

### harden-forward-sync-parallel-version-bump-contention
