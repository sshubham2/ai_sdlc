...
- **Lives at**: `<HOME>\ai_sdlc\skills\diagnose\SKILL.md`
- **Key changes**:
...
- **Lives at**: `<HOME>\ai_sdlc\architecture\risk-register.md`
...
- **Lives at**: `<HOME>\ai_sdlc\tests\skills\diagnose\test_skill_md_pins.py`
...
- **Lives at**: `<HOME>\ai_sdlc\tests\methodology\test_risk_register_audit_real_file.py` (new file)
