...
- **Lives at**: `<HOME>\ai_sdlc\skills\diagnose\write_pass.py` (created by this slice)
- **Key interactions**:
...
- **Lives at**: `<HOME>\ai_sdlc\skills\diagnose\assemble.py` (modified)
- **Key interactions**:
...
- **Lives at**: `<HOME>\ai_sdlc\skills\diagnose\SKILL.md` (modified)
- **Key changes**:
...
- **Lives at**: `<HOME>\ai_sdlc\skills\diagnose\passes\*.md`
