"""Stale-branch classifier — parallel-aware stale-vs-active discriminator.
...
from tools.pulse_worktree_resolver import _parse_worktree_porcelain
...
# pulse_worktree_resolver._SLICE_BRANCH_RE at L73). A worktree-backed branch that
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m tools.stale_branch_classifier",
        description=(
